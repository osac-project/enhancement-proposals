...
- Networking resource metering — defined by [OSAC-3145 Networking Metering](/enhancements/OSAC-3145-metering-networking), covering the supported VirtualNetwork, Subnet, ExternalIP, and NATGateway resource usage and its authoritative deployment, tenant, project, pool, attachment, and attribution dimensions.
