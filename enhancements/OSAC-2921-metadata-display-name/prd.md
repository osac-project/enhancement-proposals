...
- Two new shared Metadata fields: `display_name` (optional, max 63 characters) and `description` (optional, max 256 characters, **Markdown**) — both mutable, clearable, and not required to be unique `[Clarify: R2.Q1, R3.Q1, R4.Q4, PR review: sk-ilya]`
...
Revised: 2026-08-13 — keep `display_name`, Markdown MUST for `description`, i18n deferred without reserved fields (osac#263)
